...
from Reconstruction_3D.models.marrnet1 import Model as DepthModel
from Reconstruction_3D.models.marrnet1 import Net as Net1
from Reconstruction_3D.networks.uresnet import Net_inpaint as Uresnet
from Reconstruction_3D.toolbox.cam_bp.cam_bp.modules.camera_backprojection_module import Camera_back_projection_layer
from Reconstruction_3D.toolbox.spherical_proj import render_spherical, sph_pad
...
class Net(nn.Module):
    def __init__(self, opt, base_class=Model):
        ...
        if opt.net1_path:
            ...
            self.net1.load_state_dict(new_weights)
